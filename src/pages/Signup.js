          ...
          <div className="col-12">
            <div className="auth-card">
              ...
              <form action="" onSubmit={formik.handleSubmit} className='d-flex flex-column gap-15'>
                ...
                <CustomInput type="text" placeholder="Last Name" name='lastname' value={formik.values.lastname} onChange={formik.handleChange("lastname")}
                ...
                <CustomInput type="password" name='password' placeholder='Password' value={formik.values.password} onChange={formik.handleChange("password")}
